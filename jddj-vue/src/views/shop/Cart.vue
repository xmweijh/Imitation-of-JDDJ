  ...
  <div class="cart">
    <div class="product" v-if="showCart && calculations.total > 0">
      <div class="product__header">
        <div class="product__header__all" @click="() => setCartItemsChecked(shopId, calculations.allChecked)">
          <span class="product__header__icon iconfont" :class="calculations.allChecked ? 'icon-quanxuan' : 'icon-weixuanzhongyuanquan'">
          </span>
          全选
        </div>
