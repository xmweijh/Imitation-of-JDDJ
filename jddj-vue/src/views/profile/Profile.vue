<template>
    <div class="wrapper">
        <div class="content">
            <div class="header">
                <div class="header__edit-btn iconfont icon-gengxintouxiang"></div>
                <div class="header__card">
                    <img src="https://tx-free-imgs2.acfun.cn/kimg/EJvM1y8qOwoFYWNmdW4SBWltYWdlGis5MTEzOTRfZDRhMWNjOGRjODQ3NDBlMDkxYTI4NzhmODllMjYwYzgucG5n.webp"
                        class="header__card__img">
            ...
            <div class="links">
                <div class="links__item">
                    <span class="iconfont links__item__yen icon-qianbao"></span>
                    <span class="links__item__text">我的钱包</span>
                    <span class="iconfont links__item__enter icon-fanhui"></span>
                </div>
                <router-link :to="{ name: 'AddressList' }">
                <div class="links__item">
                    <span class="iconfont links__item__address icon-dizhiguanli"></span>
                    <span class="links__item__text">我的地址</span>
                    <span class="iconfont links__item__enter icon-fanhui"></span>
                </div>
                </router-link>
                <div class="links__item">
                    <span class="iconfont links__item__service icon-kehufuwukefu"></span>
